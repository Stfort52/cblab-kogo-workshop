...
``` r
filtering <- function(sce,umi,mtpct){
  filter_by_total_counts = sce$sum > umi
  filter_by_mt_percent = sce$subsets_MT_percent < mtpct
...
``` r
sce <- cbind(sce.1, sce.2, sce.3, sce.4, sce.6, sce.7, sce.8, sce.9, sce.12)
sce$library <-'NA'
...
```
    ...
    ## 
    ##   L1  L12   L2   L3   L4   L6   L7   L8   L9 
    ## 3883 4617 3799 3313 1757  703  954 2804 1273
